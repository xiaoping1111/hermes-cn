"""命令行界面测试 - 提供商·配置管理·validation

【产品经理理解要点】
验证命令行界面的提供商配置管理功能
- 验证的功能: Tests for providers config entry validation and normalization
- 核心测试场景: valid entry snake case、camel case api key mapped、camel case base url mapped 等共17个场景
