...
【产品经理理解要点】
验证命令行界面相关功能的正确性
- 验证的功能: Tests for hermes_cli/goals.py — persistent cross-turn goals
- 核心测试场景: goal command in registry、goal command dispatches in cli registry helpers、clean json done 等共50个场景
