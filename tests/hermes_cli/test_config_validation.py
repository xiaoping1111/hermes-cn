"""命令行界面测试 - 配置管理·validation

【产品经理理解要点】
验证命令行界面的配置管理功能
- 验证的功能: Tests for config.yaml structure validation (validate_config_structure)
- 核心测试场景: dict instead of list、dict detects misplaced fields、dict detects nested fallback 等共21个场景
