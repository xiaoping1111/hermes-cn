...
【产品经理理解要点】
验证命令行界面相关功能的正确性
- 验证的功能: Tests for hermes_cli/completion.py — shell completion script generation
- 核心测试场景: top level subcommands extracted、nested subcommands extracted、aliases not duplicated 等共31个场景
