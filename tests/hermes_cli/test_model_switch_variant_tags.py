...
【产品经理理解要点】
验证命令行界面模型切换的正确性
- 验证的功能: Tests for OpenRouter variant tag preservation in model switching
- 核心测试场景: slash format preserves variant tag、legacy colon format converts to slash、legacy colon format with tag converts first colon only 等共5个场景
