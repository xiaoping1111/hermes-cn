...
【产品经理理解要点】
验证命令行界面的降级策略功能
- 验证的功能: Tests for `hermes fallback` — chain reading, add/remove/clear, legacy migration
- 核心测试场景: returns empty list when unset、reads new list format、migrates legacy single dict 等共30个场景
