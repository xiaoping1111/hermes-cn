...
【产品经理理解要点】
验证命令行界面的设置配置管理功能
- 验证的功能: Tests for the setup wizard's returning-user behavior
- 核心测试场景: bare setup runs full reconfigure without menu、reconfigure flag is backwards compat noop、quick flag runs quick setup only 等共9个场景
