"""命令行界面测试 - azure·foundry·entra

【产品经理理解要点】
验证命令行界面相关功能的正确性
- 验证的功能: Tests for Azure Foundry Entra ID runtime resolution
- 核心测试场景: returns callable api key for entra、entra inherits codex responses for gpt5 family、entra propagates scope only 等共16个场景
