...
【产品经理理解要点】
验证命令行界面看板CLI命令的正确性
- 验证的功能: Tests for the kanban CLI surface (hermes_cli.kanban)
- 核心测试场景: parse workspace flag valid、parse workspace flag expands user、parse workspace flag rejects 等共37个场景
