"""命令行界面测试 - 技能系统·skip·confirm

【产品经理理解要点】
验证命令行界面的技能系统功能
- 验证的功能: Tests for skip_confirm and invalidate_cache behavior in /skills install
- 核心测试场景: yes flag sets skip confirm、y flag sets skip confirm、force flag sets force 等共15个场景
