...
【产品经理理解要点】
验证命令行界面数据迁移的正确性
- 验证的功能: Tests for OpenClaw migration integration in the setup wizard
- 核心测试场景: skips when no openclaw dir、skips when migration script missing、skips when user declines 等共33个场景
