"""命令行界面测试 - 多配置文件·distribution

【产品经理理解要点】
验证命令行界面的多配置文件功能
- 验证的功能: Tests for hermes_cli.profile_distribution — git-based profile installs
- 核心测试场景: minimal manifest、full manifest、missing name rejected 等共42个场景
