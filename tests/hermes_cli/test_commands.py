...
【产品经理理解要点】
验证命令行界面的命令处理功能
- 验证的功能: Tests for the central command registry and autocomplete
- 核心测试场景: registry is nonempty、every entry is commanddef、no duplicate canonical names 等共144个场景
