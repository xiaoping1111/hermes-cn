...
【产品经理理解要点】
验证命令行界面相关功能的正确性
- 验证的功能: Tests for the `hermes proxy` subcommand and its upstream adapters
- 核心测试场景: registry lists nous、registry lists xai、get adapter returns instance 等共36个场景
