...
【产品经理理解要点】
验证命令行界面相关功能的正确性
- 验证的功能: Tests for hermes_cli.skin_engine — the data-driven skin/theme system
- 核心测试场景: default skin has required fields、get color with fallback、get branding with fallback 等共33个场景
