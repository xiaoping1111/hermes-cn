"""CLIplugins transcription registration测试

【产品经理理解要点】
CLIplugins transcription registration功能测试。
- 验证功能：命令行plugins transcription registration功能
- 关键场景：配置、执行、验证
- 业务影响：plugins transcription registration命令行功能失效
