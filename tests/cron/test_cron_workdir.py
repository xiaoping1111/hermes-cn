...
【产品经理理解要点】
验证定时任务调度引擎的工作目录功能
- 验证的功能: Tests for per-job workdir support in cron jobs
- 核心测试场景: none returns none、empty string returns none、absolute existing dir returns resolved str 等共21个场景
