"""Dockerfile node_modules权限测试

【产品经理理解要点】
验证工具系统模块中dockerfile chowns runtime node modules to hermes user的正确性
- dockerfile chowns runtime node modules to hermes user的正确性验证
- 影响工具系统的可靠性和功能正确性
