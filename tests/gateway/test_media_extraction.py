"""消息网关测试 - 媒体处理·extraction

【产品经理理解要点】
验证消息网关的媒体处理功能
- 验证的功能: Tests for MEDIA tag extraction from tool results
- 核心测试场景: media tags not extracted from history、media tags extracted from current turn、multiple tts calls in history not accumulated 等共4个场景
