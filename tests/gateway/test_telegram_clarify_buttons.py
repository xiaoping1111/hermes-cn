"""消息网关测试 - Telegram平台·clarify·buttons

【产品经理理解要点】
验证消息网关的Telegram平台功能
- 验证的功能: Tests for Telegram inline keyboard clarify buttons
- 核心测试场景: multi choice renders buttons and other、open ended no keyboard、not connected 等共12个场景
