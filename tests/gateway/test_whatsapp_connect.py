"""消息网关测试 - WhatsApp平台·平台连接

【产品经理理解要点】
验证消息网关的WhatsApp平台平台连接功能
- 验证的功能: Tests for WhatsApp connect() error handling
- 核心测试场景: closes open handle、noop when no handle、suppresses close exception 等共25个场景
