...
【产品经理理解要点】
验证消息网关WhatsApp回复前缀的正确性
- 验证的功能: Tests for WhatsApp reply_prefix config.yaml support
- 核心测试场景: reply prefix bridged from yaml、empty reply prefix bridged、no whatsapp section no extra 等共8个场景
