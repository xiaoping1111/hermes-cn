"""消息网关测试 - feishu·approval·buttons

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for Feishu interactive card approval buttons
- 核心测试场景: sends interactive card、stores approval state、not connected 等共31个场景
