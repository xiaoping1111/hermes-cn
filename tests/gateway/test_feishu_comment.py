"""消息网关测试 - feishu·comment

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for feishu_comment — event filtering, access control integration, wiki reverse lookup
- 核心测试场景: parse valid event、parse missing event attr、parse none event 等共20个场景
