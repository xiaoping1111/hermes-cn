...
【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for the Weixin platform adapter
- 核心测试场景: format message preserves markdown、format message preserves markdown tables、format message preserves fenced code blocks 等共54个场景
