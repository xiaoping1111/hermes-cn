"""消息网关测试 - goal·verdict·消息发送

【产品经理理解要点】
验证消息网关的消息发送功能
- 验证的功能: Tests for gateway /goal verdict-message delivery
- 核心测试场景: goal verdict done sent via adapter send、goal verdict continue enqueues continuation、goal verdict budget exhausted sends pause 等共5个场景
