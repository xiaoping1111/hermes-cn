"""消息网关测试 - api·server·normalize

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for _normalize_chat_content in the API server adapter
- 核心测试场景: none returns empty string、plain string returned as is、empty string returned as is 等共17个场景
