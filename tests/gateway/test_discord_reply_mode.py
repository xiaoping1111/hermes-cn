"""消息网关测试 - Discord平台·回复处理·mode

【产品经理理解要点】
验证消息网关的Discord平台回复处理功能
- 验证的功能: Tests for Discord reply_to_mode functionality
- 核心测试场景: default mode is first、off mode、first mode 等共33个场景
