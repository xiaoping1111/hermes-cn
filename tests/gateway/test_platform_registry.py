"""消息网关测试 - platform·registry

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for the platform adapter registry and dynamic Platform enum
- 核心测试场景: builtin members still work、dynamic member created、dynamic member identity stable 等共43个场景
