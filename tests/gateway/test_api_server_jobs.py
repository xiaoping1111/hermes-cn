"""消息网关测试 - api·server·任务管理

【产品经理理解要点】
验证消息网关的任务管理功能
- 验证的功能: Tests for the Cron Jobs API endpoints on the API server adapter
- 核心测试场景: list jobs、list jobs include disabled、list jobs default excludes disabled 等共35个场景
