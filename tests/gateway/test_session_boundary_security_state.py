"""网关session boundary security state测试

【产品经理理解要点】
网关session boundary security state功能测试。
- 验证功能：网关session boundary security state处理
- 关键场景：核心逻辑、边界条件、错误处理
- 业务影响：session boundary security state功能异常
