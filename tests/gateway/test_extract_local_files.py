"""消息网关测试 - extract·local·files

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for extract_local_files() — auto-detection of bare local file paths
- 核心测试场景: absolute path image、tilde path image、video extensions 等共44个场景
