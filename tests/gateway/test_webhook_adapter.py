"""消息网关测试 - Webhook·adapter

【产品经理理解要点】
验证消息网关的Webhook功能
- 验证的功能: Unit tests for the generic webhook platform adapter
- 核心测试场景: validate github signature valid、validate github signature invalid、validate gitlab token 等共43个场景
