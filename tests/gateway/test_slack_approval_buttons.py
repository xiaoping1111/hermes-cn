"""消息网关测试 - Slack平台·approval·buttons

【产品经理理解要点】
验证消息网关的Slack平台功能
- 验证的功能: Tests for Slack Block Kit approval buttons and thread context fetching
- 核心测试场景: sends blocks with buttons、sends in thread、not connected 等共23个场景
