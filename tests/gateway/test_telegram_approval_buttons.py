"""消息网关测试 - Telegram平台·approval·buttons

【产品经理理解要点】
验证消息网关的Telegram平台功能
- 验证的功能: Tests for Telegram inline keyboard approval buttons
- 核心测试场景: sends inline keyboard、stores approval state、sends in thread 等共20个场景
