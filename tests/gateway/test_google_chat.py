...
【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for Google Chat platform adapter
- 核心测试场景: enum value、requirements check returns true when available、missing subscription does not enable 等共148个场景
