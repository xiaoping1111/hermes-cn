"""消息网关测试 - WhatsApp平台·formatting

【产品经理理解要点】
验证消息网关的WhatsApp平台功能
- 验证的功能: Tests for WhatsApp message formatting and chunking
- 核心测试场景: bold double asterisk、bold double underscore、strikethrough 等共26个场景
