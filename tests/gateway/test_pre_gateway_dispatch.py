"""消息网关测试 - pre·gateway·dispatch

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for the pre_gateway_dispatch plugin hook
- 核心测试场景: hook skip short circuits dispatch、hook rewrite replaces event text、hook allow falls through to auth 等共5个场景
