"""消息网关测试 - pii·redaction

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for PII redaction in gateway session context prompts
- 核心测试场景: hash id deterministic、hash id 12 hex chars、hash sender id prefix 等共16个场景
