"""消息网关测试 - Signal平台·format

【产品经理理解要点】
验证消息网关的Signal平台功能
- 验证的功能: Tests for Signal _markdown_to_signal() formatting
- 核心测试场景: bold double asterisk、bold double underscore、italic single asterisk 等共50个场景
