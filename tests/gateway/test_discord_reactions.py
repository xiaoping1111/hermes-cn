"""消息网关测试 - Discord平台·reactions

【产品经理理解要点】
验证消息网关的Discord平台功能
- 验证的功能: Tests for Discord message reactions tied to processing lifecycle hooks
- 核心测试场景: process message background adds and swaps reactions、interaction backed events do not attempt reactions、reaction helper failures do not break message flow 等共7个场景
