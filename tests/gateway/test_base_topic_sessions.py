"""消息网关测试 - base·topic·会话管理

【产品经理理解要点】
验证消息网关的会话管理功能
- 验证的功能: Tests for BasePlatformAdapter topic-aware session handling
- 核心测试场景: handle message does not interrupt different topic、handle message interrupts same topic、process message background replies in same topic 等共10个场景
