...
【产品经理理解要点】
验证消息网关的Matrix平台功能
- 验证的功能: Tests for Matrix platform adapter (mautrix-python backend)
- 核心测试场景: apply env overrides with access token、apply env overrides with password、matrix not loaded without creds 等共147个场景
