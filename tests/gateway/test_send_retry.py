...
【产品经理理解要点】
验证消息网关的消息发送重试机制功能
- 验证的功能: Tests for BasePlatformAdapter._send_with_retry and _is_retryable_error
- 核心测试场景: none is not retryable、empty string is not retryable、known pattern is retryable 等共27个场景
