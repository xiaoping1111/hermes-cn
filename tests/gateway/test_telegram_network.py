"""消息网关测试 - Telegram平台·network

【产品经理理解要点】
验证消息网关的Telegram平台功能
- 验证的功能: Tests for gateway.platforms.telegram_network – fallback transport layer
- 核心测试场景: filters invalid and ipv6、none returns empty、empty string returns empty 等共46个场景
