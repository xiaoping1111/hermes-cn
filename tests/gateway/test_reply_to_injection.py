...
【产品经理理解要点】
验证消息网关的回复处理注入防护功能
- 验证的功能: Tests for reply-to pointer injection in _prepare_inbound_message_text
- 核心测试场景: reply prefix injected when text absent from history、reply prefix still injected when text in history、no prefix without reply context 等共5个场景
