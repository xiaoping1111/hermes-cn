"""消息网关测试 - platform·base

【产品经理理解要点】
验证消息网关相关功能的正确性
- 验证的功能: Tests for gateway/platforms/base.py — MessageEvent, media extraction, message truncation
- 核心测试场景: gateway secret capture message points to local setup、strips query fragment and userinfo、truncates long values 等共92个场景
