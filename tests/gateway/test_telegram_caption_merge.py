"""消息网关测试 - Telegram平台·caption·merge

【产品经理理解要点】
验证消息网关的Telegram平台功能
- 验证的功能: Tests for TelegramPlatform._merge_caption caption deduplication logic
- 核心测试场景: no existing text、empty existing text、exact duplicate dropped 等共13个场景
