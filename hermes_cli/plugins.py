...
【产品经理理解要点】
插件的发现、加载和生命周期管理，是 Hermes 可扩展性的核心基础设施。
- 四大插件来源：内置插件、用户插件、项目插件、Pip 入口点插件
- 插件可注册工具、生命周期钩子、CLI 命令、斜杠命令、平台适配器等
- 支持启用/禁用控制，用户插件优先级高于内置插件
- 插件通过 register(ctx) 函数向宿主注册能力
