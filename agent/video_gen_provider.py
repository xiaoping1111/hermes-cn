...
【产品经理理解要点】
定义视频生成的插件化后端接口，统一文生视频和图生视频两种模式。
- 核心职责：定义 VideoGenProvider ABC(generate/poll)、文生视频/图生视频路由
- 关键业务概念：文生视频(text-to-video)、图生视频(image-to-video)、异步轮询
- 在系统中的位置：video_generate 工具的供应商抽象层
