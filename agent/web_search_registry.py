...
【产品经理理解要点】
管理网页搜索后端插件，按配置和能力选择活跃搜索/提取供应商。
- 核心职责：维护搜索/提取供应商映射、配置优先-唯一可用-历史偏好回退
- 关键业务概念：search_backend/extract_backend 独立选择、遗留偏好顺序
- 在系统中的位置：web_search/web_extract 工具的供应商调度入口
